...
def main():
    ...
    # Обновленная функция для парсинга данных карточки с обработкой ошибок и повторных попыток
    @st.cache
    ...
    # Обновленная функция для поиска товаров по API Wildberries
    @st.cache
    ...
    if search_query:
        ...
        if df.empty:
            ...
            for idx, row in df.iterrows():
                ...
                # Задержка для уменьшения шанса получения 429
                time.sleep(0.5)
